...
function Hero() {
  return (
    <section className="relative overflow-hidden border-b border-border bg-background">
      ...
      />
      <div className="relative max-w-7xl mx-auto px-5 sm:px-8 py-10 sm:py-16 lg:py-24 min-h-[calc(100svh-4rem)] sm:min-h-[70vh] lg:min-h-[85vh] grid lg:grid-cols-12 gap-10 lg:gap-14 items-center justify-items-center lg:justify-items-stretch text-center lg:text-left">
