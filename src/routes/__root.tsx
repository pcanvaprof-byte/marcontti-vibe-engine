...
import { SiteForSalePopup } from "../components/SiteForSalePopup";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/47170f13-d4e8-4998-ad0d-803ce6480425" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/47170f13-d4e8-4998-ad0d-803ce6480425" },
    ],
    links: [
