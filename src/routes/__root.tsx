...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Infinda Digital — Mobilidade Elétrica em Joinville" },
      ...
      { name: "author", content: "Infinda Digital" },
      { property: "og:site_name", content: "Infinda Digital" },
      { property: "og:locale", content: "pt_BR" },
      { property: "og:title", content: "Infinda Digital — Mobilidade Elétrica em Joinville" },
      ...
      { property: "og:image:alt", content: "Loja Infinda Digital em Joinville" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Infinda Digital — Mobilidade Elétrica em Joinville" },
