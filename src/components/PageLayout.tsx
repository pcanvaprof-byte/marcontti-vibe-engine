      ...
      <footer className="bg-card border-t border-border mt-auto">
        <div className="max-w-7xl mx-auto px-5 sm:px-8 py-10 grid gap-8 md:grid-cols-3 text-sm text-white/70">
          ...
          <div className="space-y-2 text-xs">
            ...
            <p className="inline-flex items-center gap-2"><Phone size={13} className="text-white/40" /> <a href="tel:+5547934293200" className="hover:text-primary">(47) 93429-3200</a></p>
